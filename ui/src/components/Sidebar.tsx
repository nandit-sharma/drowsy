    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        <div className="status-pill">
          ...
          <div>
            <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-primary)' }}>API Server</div>
            <div style={{ fontSize: 11, color: 'var(--text-muted)', fontFamily: 'monospace' }}>127.0.0.1:8000</div>
          </div>
        </div>
      </div>
    </aside>
